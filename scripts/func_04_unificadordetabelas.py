...
base_cc = r"data/data/base_01_cc.json"
base_cb = r"data/data/base_02_cb.json"
base_rc = r"data/data/base_03_rc.json"
...
tb_rc_final_01.to_json("data/data/base_final_04_rc.json")
